...
import com.example.diplom.Navigation.TopAppBarCreate
import com.example.diplom.Elements.Unit
import com.example.diplom.ui.theme.DiplomTheme

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CreateFixedAssets(navController: NavHostController) {
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            topBar = { TopAppBarCreate(navController) },
...
@Composable
fun CreateFixedAssetsPreview() {
    val navController = rememberNavController()
    DiplomTheme {
        CreateFixedAssets(navController)
    }
}